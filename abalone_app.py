...
v_Viscera_weight = st.sidebar.slider('Viscera_weight', min_value=0.0, max_value=1.0, value=0.2)
v_Shell_weight = st.sidebar.slider('Shell_weight', min_value=0.0, max_value=2.0, value=0.2)
